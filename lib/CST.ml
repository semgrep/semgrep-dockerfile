...
type expansion_body = [
    `Var of variable (*tok*)
  | `LCURL_imm_tok_pat_8713919_RCURL of (
        Token.t (* "{" *) * imm_tok_pat_8713919 (*tok*) * Token.t (* "}" *)
    )
]
[@@deriving sexp_of]
...
type imm_expansion = (Token.t (* "$" *) * expansion_body)
[@@deriving sexp_of]
...
type image_name = (
    [ `Pat_8165e5f of pat_8165e5f (*tok*) | `Expa of expansion ]
  * [
        `Imm_tok_pat_2b37705 of imm_tok_pat_2b37705 (*tok*)
...
type path = (
  ...
  * [
        `Imm_tok_pat_0c7fc22 of imm_tok_pat_0c7fc22 (*tok*)
      | `Imme_expa of immediate_expansion
    ]
      list (* zero or more *)
)
...
type image_alias = (
  ...
  * [
        `Imm_tok_pat_9a14b5c of imm_tok_pat_9a14b5c (*tok*)
      | `Imme_expa of immediate_expansion
    ]
      list (* zero or more *)
)
...
type immediate_user_name_or_group_fragment = [
    `Imm_tok_pat_b295287 of imm_tok_pat_b295287 (*tok*)
  | `Imme_expa of immediate_expansion
]
[@@deriving sexp_of]
...
type stopsignal_value = (
  ...
  * [
        `Imm_tok_pat_441cd81 of imm_tok_pat_441cd81 (*tok*)
      | `Imme_expa of immediate_expansion
    ]
      list (* zero or more *)
)
...
type user_name_or_group = (
    [ `Pat_b295287 of pat_b295287 (*tok*) | `Expa of expansion ]
...
type user_instruction = (
    pat_a368b76 (*tok*)
  * user_name_or_group
  * (Token.t (* ":" *) * immediate_user_name_or_group) option
)
[@@deriving sexp_of]
...
type arg_instruction = (
  ...
  * [
        `Semg_meta of semgrep_metavariable (*tok*)
      | `Pat_4de4cb9 of pat_4de4cb9 (*tok*)
    ]
...
type label_pair = [
    `Semg_ellips of Token.t (* "..." *)
  | `Choice_semg_meta_EQ_choice_double_quoted_str of (
        [
            `Semg_meta of semgrep_metavariable (*tok*)
          | `Pat_4128122 of pat_4128122 (*tok*)
        ]
      * Token.t (* "=" *)
